...
namespace DocTicket.Backend.DAL.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OffersId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PolyclinicId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Departments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Departments_Polyclinics_PolyclinicId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegistryNumbers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RegistryNumbers_Polyclinics_PolyclinicId",
                        column: x => x.PolyclinicId,
                        principalTable: "Polyclinics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkingHour_Polyclinics_PolyclinicId",
                        column: x => x.PolyclinicId,
                        principalTable: "Polyclinics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfferTicket", x => new { x.OffersId, x.TicketsId });
                    table.ForeignKey(
                        name: "FK_OfferTicket_Offers_OffersId",
                        column: x => x.OffersId,
                        principalTable: "Offers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OfferTicket_Tickets_TicketsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Departments_PolyclinicId",
                table: "Departments",
                column: "PolyclinicId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OfferTicket_TicketsId",
                table: "OfferTicket",
                column: "TicketsId");

            migrationBuilder.CreateIndex(
                name: "IX_RegistryNumbers_PolyclinicId",
                table: "RegistryNumbers",
                column: "PolyclinicId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkingHour_PolyclinicId",
                table: "WorkingHour",
                column: "PolyclinicId");
        }
